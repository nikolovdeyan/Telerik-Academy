...
namespace _11.ExtractStudentsByEmail
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Select the students with email in abv.bg
            ...
            // Print results
            Console.WriteLine("******************************************");
            Console.WriteLine("Students that have an email in www.abv.bg:");
            foreach (var student in studentsFiltered)
            {
                Console.WriteLine("Student: {0} {1} -- email: {2}", student.FirstName, student.LastName, student.Email);
            }
            Console.WriteLine();
        }
    }
