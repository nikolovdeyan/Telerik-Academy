...
namespace _14.ExtractStudentsWithTwoMarks
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Extract students with exactly two marks 'Poor (2)' using extension methods
            ...
            // Print results
            Console.WriteLine("******************************************");
            Console.WriteLine("Students with exactly two poor marks (2):");
            foreach (var student in studentsFiltered)
            {
                Console.WriteLine("Student: {0} -- Marks: {1}", student.name, string.Join(", ", student.marks));
            }
            Console.WriteLine();
        }
    }
