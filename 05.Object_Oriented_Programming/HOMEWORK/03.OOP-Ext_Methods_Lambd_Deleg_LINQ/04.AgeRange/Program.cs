...
namespace _04.AgeRange
{
    class Program
    {
        ...
        {
            // Using the same array as in task 03
            ...
            // Use LINQ to extract the first and last name of all students aged between 18 and 24
            var studentList = studentsArr.Where(student => student.Age >= 18 && student.Age < 24);

            // Print results
            Console.WriteLine("******************************************");
            Console.WriteLine("Students aged between 18 and 24 years old:");
