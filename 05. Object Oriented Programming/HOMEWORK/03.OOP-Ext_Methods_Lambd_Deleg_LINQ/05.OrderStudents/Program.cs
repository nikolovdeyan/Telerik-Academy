...
namespace _05.OrderStudents
{
    class Program
    {
        ...
        {
            // Using the same array as in tasks 03 and 04
            ...
            // Using lambda extension methods:
            var studentListLambda = studentsArr.OrderByDescending(student => student.FirstName)
                                               .ThenByDescending(student => student.LastName);

            // Print results
            Console.WriteLine("******************************************");
            Console.WriteLine("Students sorted by names in descending order using lambda extension methods:");
            foreach (var student in studentListLambda)
            {
            ...
            // Using LINQ:
            var studentListLINQ = from student in studentsArr
            ...
            // Print results
            Console.WriteLine("******************************************");
            Console.WriteLine("Students sorted by names in descending order using LINQ:");
            foreach (var student in studentListLINQ)
            {
                Console.WriteLine("Student: {0} {1}", student.FirstName, student.LastName);
            }
            Console.WriteLine();
